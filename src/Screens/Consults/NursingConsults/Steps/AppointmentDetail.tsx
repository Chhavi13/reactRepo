...
const AppoinmentDetail = ({ data, host, setData, handleNext, handleSubmit, loading, setStep, handlePrev, objName }: any) => {
    let tax = 0;
        ...
        try {
            ...
            if (isSucess) {
                ...
                if (resData.type === "amount") {
                    ...
                    let discountAmt = Number(data?.amount) - Number(discount);
                    if (discount > 0) {
            ...
            <section className='step-container step3'>
                ...
                <div className="consult-card-container selected-consult-container py-3 py-md-4 px-3 px-md-4">
                    ...
                    <div className='subtotal d-flex'>
                        ...
                        <span className='price me-0 ms-auto'><h2 className='m-0 p-0'>
                            {/* {data?.final_amount ? data?.final_amount : data?.amount} */}
                            ${data?.final_amount}
                        </h2></span>
                    </div>
                </div>
                ...
                <div className="bill-details">
                    ...
                    <ul className="pay-list px-3 px-md-4">
                        <li className="d-flex justify-content-between"><span className="payspan">To Pay</span><span className="pay-total">$
                            {couponSaving ? data?.final_amount : data.amount}
                            {/* {data?.final_amount} */}
                        </span></li>
                    </ul>
                </div>
