...
import {getAllPost} from '../features/User/getAllPost';
    ...
    const FetchData = async () => {
        ...
        try {
            ...
            if (token) {
                ...
                // console.log(AuthStr)
               let res = await dispatch(getAllPost(AuthStr))
                console.log("response Post",res.payload.data)
