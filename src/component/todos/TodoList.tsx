...
import { removeTodo,editTodo } from '../../redux/features/todo/TodoSlice';
            ...
            <ListItem
              ...
              secondaryAction={
                <Box sx={{ paddingLeft: 10, color: "green" }}>
                  <IconButton edge="end" aria-label="edit" onClick={()=>editTodos(value.id)}>
                    <ModeEditOutlineOutlinedIcon  />
                  </IconButton>
                  <IconButton edge="end" aria-label="delete " onClick={() => dispatch(removeTodo(value.id))}>
