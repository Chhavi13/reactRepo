...
import History from "../../assets/images/mobileimages/history.png";
import Heart from "../../assets/images/mobileimages/heartblack.svg";
import Comment from "../../assets/images/mobileimages/chat.png";
import Lock from "../../assets/images/mobileimages/lock.png";
...
export const OfferDetail = ({count,item, setLike, index, stepperCase, isPreview,
  ...
  const profile = (id: any) => {
    path === '/dashboard' &&
      history.push(`user-profile/${id?.user_id}`)
  }
      ...
      <div className="yogatrainercontainer new_dash1" key={index}>
            ...
            <div className="sbrinamain_container">
              <div className="yoga_trainer">
                <LazyLoadImage effect="blur"
                  ...
                  src={item?.profile_image ? item?.profile_image : images.mobheader1}
        ...
        <div className="img_bg">
          ...
          <div className={classes.root}>
            ...
            <ImageLists item={item} openCarousel={openCarousel} />
          </div>
          {
            stepperCase &&
