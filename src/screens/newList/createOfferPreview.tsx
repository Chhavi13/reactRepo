...
export const CreateOfferPreview = ({ item, onDataHandles, base64ImagesURI, actualAPIFiles, pageData,
  ...
  //         <img src={image.file} className="media1" alt="" />
  ...
  // console.log("reducer data", createOfferStoreData)
              ...
              <div className="yogatrainercontainer new_dash1" >
                ...
                <div className="img_bg">
                  <div className={classes.root}>
                    ...
                    {
                      uriImages?.map((ImageItem: any, i: number) => {
                        if (i < 4) {
                          return (
                            <ImageListItem
                              key={i}
                              ...
                              <img
                                ...
                                onClick={() => openCarousel && openCarousel(ImageItem)}
                              />
                              {
                                uriImages.length > 4 && i === 3 &&
                                <ImageListItemBar title={`+ ${uriImages.length - 4}`} />
                              }
                            </ImageListItem>
                          )
                        }
