...
import SSRSuspense from "../screens/SSRSuspense";
...
const Routes: React.FC<any> = () => {
  ...
  return (
    <Switch>
      ...
      <PrivateRoute exact path={CREATE_INDEX} component={CreateIndex} />
      ...
      <Route path={COMPANIES_TAGS} component={SearchPost} />
      ...
      <PrivateRoute exact path={FAN_GROUP_DETAIL} component={Groups} />
      <PrivateRoute path={INVEST_ME} component={InvestMe} />
      <PrivateRoute path={SUBSCRIPTION} component={Subscription} />
      <Route component={OfferComment} path={OFFER_COMMENT} />
